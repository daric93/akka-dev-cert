...
public class BookingSlotEntityTest {
    ...
    void testUnmarkSlotAvailablePersistEventAndRepliesPreviouslyAvailableSlot() {
        ...
        var markUnavailableCommand = new BookingSlotEntity.Command.UnmarkSlotAvailable(studentParticipant);
        var result = testKit.method(BookingSlotEntity::unmarkSlotAvailable).invoke(markUnavailableCommand);
        assertEquals(Done.getInstance(), result.getReply());
    ...
    void testBookSlotPersistEventAndReplies() {
        ...
        var bookSlotCommand = new BookingSlotEntity.Command.BookReservation(studentParticipant.id(), aircraftParticipant.id(), instructorParticipant.id(), booking_1);
        var expectedEvents = List.of(
                new BookingEvent.ParticipantBooked("testkit-entity-id", studentParticipant.id(), studentParticipant.participantType(), booking_1),
                new BookingEvent.ParticipantBooked("testkit-entity-id", instructorParticipant.id(), instructorParticipant.participantType(), booking_1),
                new BookingEvent.ParticipantBooked("testkit-entity-id", aircraftParticipant.id(), aircraftParticipant.participantType(), booking_1)
                );
        ...
        testKit.method(BookingSlotEntity::markSlotAvailable).invoke(new BookingSlotEntity.Command.MarkSlotAvailable(studentParticipant));
        testKit.method(BookingSlotEntity::markSlotAvailable).invoke(new BookingSlotEntity.Command.MarkSlotAvailable(aircraftParticipant));
        testKit.method(BookingSlotEntity::markSlotAvailable).invoke(new BookingSlotEntity.Command.MarkSlotAvailable(instructorParticipant));
    ...
    void testCancelBookingPersistEventsForAllAndReplies() {
        ...
        var bookSlotCommand = new BookingSlotEntity.Command.BookReservation(studentParticipant.id(), aircraftParticipant.id(), instructorParticipant.id(), booking_1);
        var expectedEvents = List.of(
                new BookingEvent.ParticipantCanceled("testkit-entity-id", studentParticipant.id(), studentParticipant.participantType(), booking_1),
                new BookingEvent.ParticipantCanceled("testkit-entity-id", instructorParticipant.id(), instructorParticipant.participantType(), booking_1),
                new BookingEvent.ParticipantCanceled("testkit-entity-id", aircraftParticipant.id(), aircraftParticipant.participantType(), booking_1)
        );

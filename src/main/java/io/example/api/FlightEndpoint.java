...
public class FlightEndpoint extends AbstractHttpEndpoint {
    ...
    public HttpResponse createBooking(String slotId, BookingRequest request) {
        ...
        // Implementation here
        BookReservation command = new BookReservation(request.studentId, request.aircraftId, request.instructorId, request.bookingId);
        componentClient
    ...
    public HttpResponse markAvailable(String slotId, AvailabilityRequest request) {
        ...
        MarkSlotAvailable command = new MarkSlotAvailable(new Participant(request.participantId, participantType));
        componentClient
                .forEventSourcedEntity(slotId)
    ...
    public HttpResponse unmarkAvailable(String slotId, AvailabilityRequest request) {
        ...
        UnmarkSlotAvailable command = new UnmarkSlotAvailable(new Participant(request.participantId, participantType));
        componentClient
                .forEventSourcedEntity(slotId)
